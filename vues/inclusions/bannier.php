<!--Menu de compte, connexion et suivi commande-->
<div class="dropdown">
  <button class="dropbtn">
    <i class="fas fa-user-circle" style="font-size: 40px; color: rgb(255, 122, 144);"></i>
  </button>
  <div class="dropdown-content">
    <a href="../vues/pageCompteU.php">Se connecter</a>
    <a href="../vues/pageSuiviCommande.php">Suivi de commande</a>
  </div>
</div>
...
<!--Service à la clientele (à droite)-->
